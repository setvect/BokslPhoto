...
public class ImageMetaExtratorTestCase {
	...
	public static void main(String[] args) {
		File file = new File("temp/20170403_194719.jpg");
		...
		//
		// This is the most generic approach. It will transparently determine
		// the file type and invoke the appropriate
		// readers. In most cases, this is the most appropriate usage. This will
		// handle JPEG, TIFF, GIF, BMP and RAW
		// (CRW/CR2/NEF/RW2/ORF) files and extract whatever metadata is
		...
		//
		// If you know the file to be a JPEG, you may invoke the
		// JpegMetadataReader, rather than the generic reader
		// used in approach 1. Similarly, if you knew the file to be a TIFF/RAW
		// image you might use TiffMetadataReader,
		// PngMetadataReader for PNG files, BmpMetadataReader for BMP files, or
		// GifMetadataReader for GIF files.
		//
		// Using the specific reader offers a very, very slight performance
		// improvement.
		//
		try {
		...
		//
		// If you only wish to read a subset of the supported metadata types,
		// you can do this by
